...
| カテゴリ | `features/categories.md` | SCR-22 | CAT-* | categories | UT-CAT / IT-CAT / E2E-ADMIN |
| 道具 | `features/tools.md` | SCR-23 | TOOL-* | tools | UT-TOOL / IT-TOOL / E2E-ADMIN |
| 日別チェック | `features/daily-checklists.md` | SCR-11 | CHECK-* | daily_checklists / daily_checklist_items | UT-CHECK / IT-CHECK / E2E-CHECK / PERF-CHECK |
