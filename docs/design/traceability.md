...
| REQ-CAT-01 | カテゴリ管理 | SCR-22 | CAT-01〜05 | categories | UT/IT-CAT, E2E-ADMIN-01 |
...
| REQ-CHECK-01 | 日付別共有表 | SCR-11 | CHECK-01,02 | daily_checklists | IT-CHECK, E2E-CHECK-01 |
| REQ-CHECK-02 | スナップショット | SCR-11 | CHECK-02 | daily_checklist_items | IT-CHECK |
| REQ-CHECK-03 | 数量・チェック自動保存 | SCR-11 | CHECK-03 | daily_checklist_items | UT/IT/E2E-CHECK |
| REQ-CHECK-04 | 管理者の手動追加 | SCR-11 | CHECK-04 | daily_checklist_items | IT-CHECK, E2E-CHECK-02 |
| REQ-CHECK-05 | 過去日閲覧のみ | SCR-11 | CHECK-01〜04 | work_date | UT/IT-CHECK, E2E-CHECK-03 |
